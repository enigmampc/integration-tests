...
import {
  EnigmaContract, EnigmaTokenContract, EnigmaContractAddress,
  EnigmaTokenContractAddress, proxyAddress, ethNodeAddr
} from './contractLoader';
...
describe('Enigma tests', () => {
  ...
  it('should deploy secret contract', async () => {
    ...
    fs.writeFile(path.join(homedir, '.enigma', 'addr-calculator.txt'), scTask.taskId, 'utf8', function (err) {
      if (err) {
