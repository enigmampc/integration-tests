...
describe("Enigma tests", () => {
  ...
  const flipcoinAddr = fs.readFileSync("/tmp/enigma/addr-flipcoin.txt", "utf-8");
  let task;
  it(
    ...
    async () => {
      ...
      task = await new Promise((resolve, reject) => {
        enigma
          .computeTask(taskFn, taskArgs, taskGasLimit, taskGasPx, accounts[0], flipcoinAddr, constants.RETRIES_COMPUTE)
