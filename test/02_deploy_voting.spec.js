...
import {
  EnigmaContract, EnigmaTokenContract, VotingETHContract, EnigmaContractAddress, EnigmaTokenContractAddress,
  proxyAddress, ethNodeAddr, VotingETHContractAddress
} from './contractLoader';
...
describe('Enigma tests', () => {
  ...
  it('should deploy secret contract', async () => {
    ...
    fs.writeFile(path.join(homedir, '.enigma', 'addr-voting.txt'), scTask.taskId, 'utf8', function (err) {
      if (err) {
